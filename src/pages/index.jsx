...
export default function Home() {
  ...
  return (
    <HomenLayout>
      ...
      >
        <p>
          Depuis le milieu des années 1980 à aujourd'hui, Mario a vécu des tas d'aventures : plus de <strong>200</strong> !
          Connaissez-vous tous les jeux où lui et ses amis apparaissent ?
        </p>
        <p>
