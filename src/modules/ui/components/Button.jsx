...
const Button = styled.button`
    ...
    color: ${({ theme, $primary }) => $primary ? theme.palette.text.contrasted : theme.palette.text.default};
    background-color: ${({ theme, $primary }) => $primary ? theme.palette.button.primary : theme.palette.background.secondary};
